...
- (void)toggleCamera
{
    ...
    if (self.toggleBtnBlock != nil) {
        [UIView transitionWithView:_actionViewController.view duration:.6 options:UIViewAnimationOptionAllowAnimatedContent | UIViewAnimationOptionTransitionFlipFromLeft animations:^{
...
- (UIButton *)openStickerSetBtn
{
    if (!_openStickerSetBtn) {
        _openStickerSetBtn = [[UIButton alloc]initWithFrame:CGRectMake(10, ScreenHeight_KW - 30 - 50, 50, 50)];
        ...
        dispatch_sync(dispatch_get_main_queue(), ^{
            ...
            switch (iDeviceOrientation) {
                ...
                case UIDeviceOrientationPortraitUpsideDown:
                    ...
                    [self resetWithUI:self.openStickerSetBtn frame:CGRectMake(41, self.kwSdk.varHeight - 45 - 38, 38, 38)];
...
- (UISlider *)sliderEyeMagnifying
{
    if (!_sliderEyeMagnifying) {
        ...
        if (![KWSaveData floatForKey:@"sliderEyeMagnifying"]) {
            ...
            _sliderEyeMagnifying.value = 50;
            [KWSaveData setFloat:50 forKey:@"sliderEyeMagnifying"];
...
- (UISlider *)sliderChinSlimming
{
    if (!_sliderChinSlimming) {
        ...
        if (![KWSaveData floatForKey:@"sliderChinSlimming"]) {
            ...
            _sliderChinSlimming.value = 43;
            [KWSaveData setFloat:43 forKey:@"sliderChinSlimming"];
...
- (UIButton *)beautifyOptionsBtn
{
    if (!_beautifyOptionsBtn) {
        _beautifyOptionsBtn = [[UIButton alloc]initWithFrame:CGRectMake((ScreenWidth_KW - 46 * 5) / 6 * 3 + 46 * 2, 0, 46, 42)];
