...
- (void)setupBaseToolboxView {
    ...
    flashButton.frame = CGRectMake(PLS_SCREEN_WIDTH - 100, 12, 35, 35);
...
- (void)setupRecordToolboxView {
    ...
    center.x = CGRectGetWidth([UIScreen mainScreen].bounds) - 50 + 15;
    self.endButton = [UIButton buttonWithType:UIButtonTypeCustom];
    self.endButton.frame = CGRectMake(PLS_SCREEN_WIDTH - 15 - 50, PLS_SCREEN_HEIGHT - 80, 50, 50);
